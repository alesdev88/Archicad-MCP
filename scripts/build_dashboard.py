...
WRAPPED_BY: dict[str, list[str]] = {
    "API.GetAllElements": ["find_elements", "get_model_summary"],
    "API.GetSelectedElements": ["find_elements", "get_selection"],
    "GetAllElements": ["find_elements", "get_model_summary"],
    "GetElementsByType": ["find_elements"],
    "GetSelectedElements": ["find_elements"],
    "API.GetTypesOfElements": ["find_elements", "get_element_data"],
    "API.GetPropertyIds": ["find_elements", "get_element_data", "search_definitions"],
    "API.GetPropertyValuesOfElements": ["find_elements", "get_element_data"],
    "API.GetPropertyDefinitionAvailability": ["find_elements"],
    "API.GetClassificationsOfElements": ["find_elements", "get_element_data"],
    "API.GetAllClassificationSystems": ["find_elements", "get_element_data"],
    "API.GetAllClassificationsInSystem": ["find_elements"],
    "GetIFCPropertiesOfElements": ["get_element_data"],
    "GetDetailsOfElements": ["find_elements", "get_element_data"],
    ...
    "API.GetAllPropertyNames": ["search_definitions"],
    "API.GetDetailsOfProperties": ["search_definitions"],
    "API.GetLineAttributes": ["search_definitions"],
    "API.GetFillAttributes": ["search_definitions"],
    "API.GetLayerCombinationAttributes": ["search_definitions"],
    "API.GetPenTableAttributes": ["search_definitions"],
    ...
    "API.GetAttributesByType": ["list_attributes", "search_definitions"],
    "API.GetLayerAttributes": ["list_attributes", "search_definitions"],
    "API.GetBuildingMaterialAttributes": ["list_attributes", "search_definitions"],
    "API.GetCompositeAttributes": ["list_attributes", "search_definitions"],
    "API.GetSurfaceAttributes": ["list_attributes", "search_definitions"],
...
TOOLS: list[dict] = [
    ...
    {"name": "search_definitions", "cat": "Discovery & model", "mode": "full",
     "desc": "Fuzzy search over property and attribute definitions. Returns the exact property address the other tools accept, its value and measure type, and whether it is editable. Definitions only, never values."},
    # Elements
    {"name": "find_elements", "cat": "Elements", "mode": "full",
     "desc": "Find elements by criteria groups: element types, property comparisons (22 operators, AND/OR within a group, OR between groups), classification branch tests, story. Returns GUIDs and counts."},
