...
| Platform | File |
|---|---|
| Windows | `archicad-mcp-0.6.0-win32.mcpb` |
| macOS (Apple silicon) | `archicad-mcp-0.6.0-darwin-arm64.mcpb` |
...
#    uv tool install https://github.com/alesdev88/Archicad-MCP/releases/download/v0.6.0/archicad_mcp_server-0.6.0-py3-none-any.whl
...
uv tool install git+https://github.com/alesdev88/Archicad-MCP.git@v0.6.0   # a release
```
...
```bash
uv run python scripts/check_release_version.py v0.6.0
